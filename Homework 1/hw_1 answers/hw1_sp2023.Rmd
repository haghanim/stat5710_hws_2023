...
print(ed.plt+ ggtitle("Education Distribution")+labs(x = "Levels of Education")) + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
#US Income
US.pop.data1 <- read.csv("/Users/haghanim/Dropbox/School/UPenn/Spring 2023 | 5th Year 2/STAT 5710/Homework 1/US_population_data.csv", header = TRUE, sep = ",")
...
print(US.income.plot+ ggtitle("US Income Distribution")+labs(x = "Income ($)")+
...
```{r}
# Age
US.Age <- read.csv("/Users/haghanim/Dropbox/School/UPenn/Spring 2023 | 5th Year 2/STAT 5710/Homework 1/AGEdataUS.csv", header = TRUE, sep = ",")
