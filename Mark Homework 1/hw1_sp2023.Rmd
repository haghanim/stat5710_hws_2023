...
df_m_s <- df %>%
  ...
  sprintf("there are %i males with science related majors", nrow(df_m_s))

df_m_ns <- df %>%
  filter(Field == 'Non-S&E', Sex == 'Male')
  num_non_s_males = nrow(df_m_ns)

sprintf("there are %i males with non-science related majors", num_non_s_males)

print("There are more males in science-related fields than those in Non-S&E as 297 > 33")
